...
function SScryer_Sleep(pUnit)
        ss_target = pUnit:GetRandomPlayer(7)
...
function Vishas_OnCombat(pUnit, event)
        pUnit:SendChatMessage(12,0,"Tell me... tell me everything!")
...
function Vishas_75(pUnit, event)
	if pUnit:GetHealthPct() <75 then
	    pUnit:RemoveEvents()
    	pUnit:SendChatMessage(12,0,"Naughty secrets!")
...
function Vishas_25(pUnit, event)
	if pUnit:GetHealthPct() <25 then
	    pUnit:RemoveEvents()
	    pUnit:SendChatMessage(12,0,"I'll rip the secrets from your flesh!")
...
function Vishas_KillPlayer(pUnit)
        pUnit:SendChatMessage(12,0,"Purged by pain!")
...
function Thalnos_Aggro(pUnit)
        pUnit:SendChatMessage(12,0,"We hunger for vengeance.")
...
function Thalnos_Health(pUnit, event)
    if pUnit:GetHealthPct() <50 then
	    pUnit:RemoveEvents()
		pUnit:SendChatMessage(12,0,"No rest, for the angry dead.")
