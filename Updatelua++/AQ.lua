...
TcTimer=math.random(45000,65000)
...
SsTimer=math.random(45000,65000)
...
PTimer=math.random(45000,65000)
...
function Defender_OnKilledTarget(pUnit)
end
...
RegisterUnitEvent(15277, 3, "Defender_OnKilledTarget")
...
RootTimer=math.random(15000,30000)
...
FearTimer=math.random(15000,30000)
...
CloudTimer=math.random(12000,25000)
...
SilenceTimer=math.random(12000,25000)
...
NovaTimer=math.random(25000,45000)
...
RootOrFear=math.random(1,2)
DustOrSilence=math.random(1,2)
