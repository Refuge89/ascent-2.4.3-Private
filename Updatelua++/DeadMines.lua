...
PlayerLowRange = pUnit:GetRandomPlayer(1)
...
RandomPlayer = pUnit:GetRandomPlayer(0)
...
function VanCleef_OnKilledTarget(pUnit)
        pUnit:SendChatMessage(12,0,"And stay down!")
